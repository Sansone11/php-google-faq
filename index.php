        ...
        <div class="text">
            ...
            $faq = [
                ...
                [
                    ...
                    'risposta' => '<p>Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un elevata sicurezza e assicurarti che le tue</p><p>informazioni sono al sicuro e accessibili quando ne hai bisogno.</p>
                ...
                [
                    ...
                    p>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente</p><p>Google offre i propri servizi per i consumatori tramite una delle due società seguenti:</p>
                    ...
                    <p>Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo</p><p>account.</p>',
                ],
                [
                    'title' => 'Stabilire il paese associato al tuo account',
                    'risposta' => '<p>Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa,</p><p>usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell ultimo anno.</p>
